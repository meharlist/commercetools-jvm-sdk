...
public interface CreateApi extends SphereClientContainer {
    ...
    default ProductCreateModel product(final ResourceIdentifiable<ProductType> productType, final LocalizedString name, final LocalizedString slug, final List<ProductVariantDraft> allVariants){
        return ProductCreateModel.of(getSphereClient(),  productType,  name,  slug, allVariants);
    }

    default ProductCreateModel product(final ResourceIdentifiable<ProductType> productType, final LocalizedString name, final LocalizedString slug, @Nullable final ProductVariantDraft masterVariant) {
